  ...
  const onLoginPress = () => {
    ...
    axios
      ...
      .catch((error) => {
        ...
        // setIsLoading(false);
        // const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2NWE4ZGVjMzUzMGFjMDk1NzVlNDI2MTQiLCJpYXQiOjE3MDYwNzk1OTksImV4cCI6MTcwNjE2NTk5OSwidHlwZSI6ImFjY2VzcyJ9.lY7pEvCupHFjmtX5f1LqOXmhO5s5R8nUgdewx8qOdHY";
        // SecureStore.setItemAsync("token", token);
        // navigation.navigate(AddOperationData);
  };
